"""
Django settings for GenAiDjango project.
...
SECRET_KEY = "django-insecure-9d-=a^y%t6m$)3j_!(n9t@_y1j97el6s@q^9k^y1b8b1)$g&%a"
...
WSGI_APPLICATION = "GenAiDjango.wsgi.application"
